...
CREATE TABLE `users` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `firstname` varchar(255) DEFAULT NULL COMMENT 'Имя покупателя',
...
-- Dump completed on 2020-10-26 23:20:30
-- MySQL dump 10.13  Distrib 8.0.21, for Win64 (x86_64)
--
...
CREATE TABLE `users` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `firstname` varchar(255) COLLATE utf8mb4_ru_0900_ai_ci DEFAULT NULL,
  `lastname` varchar(255) COLLATE utf8mb4_ru_0900_ai_ci DEFAULT NULL,
...
LOCK TABLES `users` WRITE;
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` VALUES (1,'Геннадий','Иванов','1990-10-05','2020-10-18 19:07:51','2020-10-18 19:48:49'),(2,'Наталья','Петрова','1984-11-12','2020-10-18 19:07:51','2020-10-18 19:48:49');
/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
